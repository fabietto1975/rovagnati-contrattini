...
abstract class AbstractController {
    ...
    protected function getResultData($result, $entity, $message) {
        include \Go\Instrument\Transformer\FilterInjectorTransformer::rewrite((APP_ROOT . '/config/config-local.php'), 'D:\xampp-5.6.3\htdocs\rilevazioni\backend\common\rest\controllers');
