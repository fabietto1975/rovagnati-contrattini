...
class LoggerAutoloader {
	...
	public static function autoload($className) {
		if(isset(self::$classes[$className])) {
			include \Go\Instrument\Transformer\FilterInjectorTransformer::rewrite( dirname('D:\xampp-5.6.3\htdocs\rilevazioni\backend\libraries\apache\log4php\src\main\php\LoggerAutoloader.php') . self::$classes[$className], 'D:\xampp-5.6.3\htdocs\rilevazioni\backend\libraries\apache\log4php\src\main\php');
		}
	}
}
